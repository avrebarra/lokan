...
updated: "2026-08-17"
-->
Assessment (2026-08-13): lokan already works for humans and agents, but the gap is documentation plus a few safety/ergonomics gaps that block *clean* dual use. Easy docs items are done; implementation items are parked for later.
