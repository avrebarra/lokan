...
func TestInitCreatesConfig(t *testing.T) {
	...
	if !strings.Contains(stdout, "Initialized kanlo project.") {
...
func TestInitIdempotent(t *testing.T) {
	...
	if !strings.Contains(stdout, "Already a kanlo project.") {
		t.Fatalf("stdout = %q", stdout)
	}
}
...
func TestExplicitInitRequired(t *testing.T) {
	...
	if !strings.Contains(stderr, "not a kanlo project — run kanlo init") {
